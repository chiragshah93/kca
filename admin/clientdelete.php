  ...
  <tr>
    <td colspan="2"><form id="form1" name="form1" method="post" action="">
      <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFCCCC">
        <tr class="bg-danger">
          <td width="48" align="center"><font size="5"><a href="agentdisplay.php"><span class="glyphicon glyphicon-plus"></span></a></font></td>
          <td colspan="3" align="center"><font color="#660000" size="7">  Client </font></td>
          </tr>
...
?>
        ...
        <tr>
          ...
          <td width="52"><a href="clientdisplay.php?cid=<?php echo $row['cid']?>"><font size="5"><span class="glyphicon glyphicon-pencil"></span></font></a></td>
          <td width="700"><table width="700" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="261">&nbsp;<font color="#660000"><strong>Client ID</strong>: </font><?php echo $row['cid'];?></td>
            </tr>
            <tr>
              <td>&nbsp;<font color="#660000"><strong>Name</strong>: </font><?php echo $row['clientname'];?></td>
              <td width="261">&nbsp;<font color="#660000"><strong>Address</strong>: </font><?php echo $row['address'];?></td>
            </tr>
            <tr>
              <td width="439">&nbsp;<font color="#660000"><strong>PhoneNo</strong> : </font><?php echo $row['phone'];?></td>
              <td width="261">&nbsp;<font color="#660000"><strong>Date Of Birth</strong>: </font><?php echo $row['dob'];?></td>
            </tr>
            <tr>
              <td width="439">&nbsp;<font color="#660000"><strong>Admin ID</strong>: </font><?php echo $row['adminid'];?></td>
              <td width="261">&nbsp;<font color="#660000"><strong>Agent Name</strong> : </font><?php echo $row['aname'];?></td>
            </tr>
           </table>
           <hr>
           </td>
