  ...
  <tr>
    <td colspan="2"><form id="form1" name="form1" method="post" action="">
      <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFCCCC">
        <tr class="bg-danger">
          <td width="725" colspan="3" align="center"><font color="#660000" size="7">Client</font></td>
          </tr>
...
$query  = "SELECT * FROM client LIMIT $offset, $rowsPerPage";
...
while($row = mysql_fetch_array($result))
{
	...
	<tr>
	<td><font color=#660000>Name:</font>"; echo @$row['clientname']; print"</td>
	...
	<tr>
		<td><font color=#660000>Client ID:</font>";echo @$row['cid'];print"</td>
...
$query   = "SELECT COUNT(clientname) AS numrows FROM client";
$result  = mysql_query($query) or die('Error, query failed');
